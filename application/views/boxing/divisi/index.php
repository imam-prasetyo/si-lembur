            ...
            $('#showData').on('click','.item_edit',function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('[name="txtDivisiUpdate"]').val(data.result.divisi);
                        $('[name="txtCurrentDivisiUpdate"]').val(data.result.divisi);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if(data.error_status) {
                            ...
                            $('[name="txtDivisiUpdate"]').val("");
                            $('[name="txtCurrentDivisiUpdate"]').val("");
                        ...
                        <form role="form" id="frmAdd">
                            ...
                            <div class="modal-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="txtDivisi" id="txtDivisi" class="form-control" autocomplete="off" placeholder="Divisi">
                    ...
                    <div class="modal-content">
                        <form role="form" id="frmUpdate">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="hidden" value="" name="txtCurrentDivisiUpdate"/>
                                <div class="form-group row">
                                    <label class="col-md-2 col-form-label">Divisi</label>
                                    <div class="col-md-10">
                                        <input type="text" name="txtDivisiUpdate" id="txtDivisiUpdate" class="form-control" autocomplete="off" placeholder="Divisi">
                                        <small class="text-danger">
                                            <span class="help-block"></span>
                                        </small>
                                    </div>
